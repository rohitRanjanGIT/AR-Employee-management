      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-2">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              <Label htmlFor="sw-ot2">OT 2hr (₹)</Label>
              <Input id="sw-ot2" type="number" step="0.01" min={0} placeholder="Optional" {...register('otRate2hr')} />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="sw-ot4">OT 4hr (₹)</Label>
              <Input id="sw-ot4" type="number" step="0.01" min={0} placeholder="Optional" {...register('otRate4hr')} />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="sw-ot6">OT 6hr (₹)</Label>
              <Input id="sw-ot6" type="number" step="0.01" min={0} placeholder="Optional" {...register('otRate6hr')} />
            </div>
          </div>
